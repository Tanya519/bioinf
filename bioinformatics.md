...
равно 1 (в том же порядке что и в тождественной перестановке). По определению, для любого положительного элемента k < n оба (k k + 1) и (−(k + 1) −k) являются **смежностями**. Если
