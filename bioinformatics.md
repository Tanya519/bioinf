...
равно 1 (в том же порядке что и в тождественной перестановке(-7,-8 можно 10,9 - нельзя)). По определению, для любого положительного элемента k < n оба (k k + 1) и (−(k + 1) −k) являются **смежностями**. Если
