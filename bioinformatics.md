...
Еще одна проблема - неполнота покрытия. Эйлеров путь найти не получится. Но можно найти длинные участки генома **контиги** (contiguous genome segments), которые можно извлечь и в надежность которых будем верить. Будем искать non-branching paths,
