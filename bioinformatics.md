...
Антибиотики кодируются аминокислотами (как и протеины). Но не все антибиотики соответствуют догме (**ДНК** ->(транскрипция замена Тимина на Урацил (U)) **РНК **->(трансляция )
**протеин**)
