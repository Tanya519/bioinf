...
В нашей ранее определенной линейной модели подсчета очков, если σ - это штраф за вставку или удаление одного символа, то σ · ε - это штраф за вставку или удаление интервала из ε символов.

GATCCAG           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  GATCCAG

GA- C-AG     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  GA- - CAG

Эта модель затрат, к сожалению, приводит к неадекватной оценке биологических последовательностей. Мутации часто вызываются ошибками в репликации ДНК, которые вставляют или удаляют целый интервал ε нуклеотидов как единичное событие, а не как k независимых вставок или делеций. Таким образом, наказание за такое отклонение на σ · ε представляет собой чрезмерное наказание.
