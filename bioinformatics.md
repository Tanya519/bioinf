...
Как показано на рисунке ниже, фиксирование черных краев позволяет нам визуализировать эффект разворота. Как вы можете видеть, разворот удаляет (“разрывает”) два красных ребра в P (соединяющих b с c и d с a) и заменяет их двумя новыми красными ребрами (соединяющими b с d и c с a).
