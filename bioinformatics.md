...
равно 1. По определению, для любого положительного элемента k < n оба (k k + 1) и (−(k + 1) −k) являются ** смежностями **. Если
pi+1 − pi не равно 1, то мы говорим, что (pi pi+1) является ** точкой останова **.
