...
Жадным алгоритмом можем начать с любого k-мера и дальше начать наращивать нашу строку влево и вправо выуживая из k-меров нужные буквы (перекрытие по длине k-1) Но не все так просто!
