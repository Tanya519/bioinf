...
После масспека получаем информацию о массе каждого фрагмента молекулы (префикса/суффикса). На основе этой информации хотим восстановить аминокислотную последовательность.
